...
class ArenaMP(object):
        ...
        for it, agent in enumerate(self.agents):
            ...
            if agent.agent_type in ["MCTS", "Random"]:
                ...
                dict_actions[it], dict_info[it] = agent.get_action(
                    state_graph, obs[it], goal_spec, opponent_subgoal
                )
    ...
    def run(self, random_goal=False, pred_goal=None):
        ...
        success = False
        while True:
            """self.step()에서 튜플로 반환되는 값
            # obs : {0: {'edges': [...], 'nodes': [...]}}
            # reward : 0
            # done : False
            # info : {'satisfied_goals': {'on_plate_231': [...], 'on_waterglass_231': [...], 'on_wineglass_231': [...], 'on_cutleryfork_231': [...]}, 'finished': False, 'graph': {'nodes': [...], 'edges': [...]}, 'failed_exec': False}
            # _ (success) : True
            """
            # actions : {0: '[walk] <kitchen> (207)'}
            # agent_info : {0: {'plan': [...], 'subgoals': [...], 'belief': {...}, 'belief_graph': {...}, 'obs': [...]}}
            (obs, reward, done, infos, _), actions, agent_info = self.step()
